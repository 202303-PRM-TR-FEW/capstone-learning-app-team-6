  ...
  return (
    <div className="max-w-full w-5/6 h-1/2 pt-10 p-x-5">
      ...
      <div className="flex flex-row flex-wrap gap-6 p-3 ml-2">
        {/* the loop start */}
        {courses.map((course) => (
          <div className="cursor-pointer hover:outline hover:outline-2 hover:outline-blue-600 mt-5 rounded-2xl" key={course.id}>
            <img
            ...
            <h2 className="text-black font-bold text-xl pl-2 mt-3">{course.name}</h2>
