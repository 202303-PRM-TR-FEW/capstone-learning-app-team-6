      ...
      <div className={`${styles.container} mflex`}>
        ...
        <div className={styles["course-content__container"]}>
          ...
          <h3 className={styles.text}>
            Author: {props.displayedCourse.author}
          </h3>{" "}
          {/* Added */}
          <h3 className={styles.text}>
            Category: {props.displayedCourse.category}
          </h3>{" "}
          {/* Added */}
          <h3 className={styles.text}>
            Value: {props.displayedCourse.value}
          </h3>{" "}
          {/* Added */}
          <h3 className={styles.text}>
            Level: {props.displayedCourse.level}
          </h3>{" "}
          {/* Added */}
          <div className={`${styles["course-info"]} mflex`}>
            <div className={`${styles["author-container"]} mflex`}>
            ...
            <p className={`${styles["course-rate"]} mflex`}>
              ...
              {props.displayedCourse.rate}
            </p>
          </div>
        </div>
        <div className={styles["course-description__container"]}>
          <h2 className={styles.text}>Course Description</h2>
          <p>{props.displayedCourse.description}</p> {/* Updated */}
        </div>
        <div className={styles["course-content__container"]}>
          <h2 className={styles.text}>Course Content</h2>
          <p>{props.displayedCourse.content}</p> {/* Added */}
        </div>
      </div>
      {!props.actionButton && (
        <div className={`${styles["actions-container"]} mflex`}>
