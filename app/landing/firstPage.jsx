      ...
      <div className='w-1/2 flex items-center justify-center h-screen'>
        <div className='flex flex-col mx-auto w-3/6 h-54'>
          <div className='flex text-blue-500'>
            ...
            <p className='font-semibold content-center text-lg text-center m-2'>LearnU</p>         
          </div>
          <div className='mt-14'>
            <h2 className='text-5xl font-semibold tracking-wide'>Discover Passion</h2>
            <p className='text-xl font-semibold text- tracking-norml mt-8'>
              Find out what topics you find interesting,
              learn a new skills & connect with people that
              are Passion about similar topic
            </p>
          </div>
          <div>
            <button className='bg-blue-600 hover:bg-blue-500 text-white text-lg p-1 font-bold w-52 h-12 mt-10 tracking-wide rounded-xl'>GET STARTED</button>
          </div>
        </div> 
      </div>
