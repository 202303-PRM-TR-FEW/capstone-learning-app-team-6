  ...
  return (
    <div className="flex bg-gray-300 w-screen h-screen">
      <div className="w-1/2 flex items-center justify-center h-screen p-2">
        ...
        <h1 className="mb-4 mx-auto text-4xl font-semibold">Welcome to LearnU</h1>
          ...
          <input 
            className="h-20 outline outline-2 outline-slate-400 focus:outline-blue-400 text-2xl rounded p-1 pl-4 m-10 mt-0"
          ...
          <p
            className="m-10 mb-5 mx-auto mt-0 hover:underline cursor-pointer text-blue-500 font-semibold text-xl "
          >
            Forgot Password ?
          </p>
          <hr
            className="bg-slate-400 mx-auto mt-0 w-1/2 h-1 rounded"
          />
